...
@auth_router.post("/register", response_model=ResponseSchema, response_model_exclude_none=True)
...
# Затем возвращается объект ResponseSchema с сообщением "Успешное сохранение данных!"
@auth_router.post("/forgot", response_model=ResponseSchema, response_model_exclude_none=True)
