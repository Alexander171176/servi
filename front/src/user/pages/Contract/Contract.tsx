...
const Contract: React.FC = () => { // компонент страницы Договор оферты
    ...
    return (
        <>
            <PublicLayout>
                <h1 className="text-center pt-20 text-2xl tracking-tight font-extrabold text-blue-600 dark:text-white">Договор оферты</h1>
