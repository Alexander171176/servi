...
import ContactsImg from '../../assets/img/banner-contacts.jpg';

const Contacts: React.FC = () => { // компонент страницы Договор оферты

    useEffect(() => { // действия для состояния страницы 
        document.title = 'Контакты'; // установка заголовка страницы
    }, []);

    return (
        <>
            <PublicLayout>
                <h1 className="text-center pt-20 text-2xl tracking-tight font-extrabold text-blue-600 dark:text-white">Контакты</h1>
                <div className="container my-4 px-6 mx-auto dark:bg-slate-700">
                                        ...
                                        <div className="flex flex-wrap">
                                            <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                                                <div className="flex items-start">
                                                    ...
                                                    <div className="grow ml-6">
                                                        ...
                                                        <p className="text-gray-500 dark:text-gray-700">help@domatv.fun</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                                                <div className="flex items-start">
                                                    ...
                                                    <div className="grow ml-6">
                                                        <p className="font-bold mb-1">Партнёрам</p>
                                                        <p className="text-gray-500 dark:text-gray-700">partner@domatv.fun</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="mb-12 md:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                                                <div className="flex align-start">
                                                    ...
                                                    <div className="grow ml-6">
                                                        <p className="font-bold mb-1">Дилерам</p>
                                                        <p className="text-gray-500 dark:text-gray-700">dealer@domatv.fun</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                                                <div className="flex align-start">
                                                    ...
                                                    <div className="grow ml-6">
                                                        <p className="font-bold mb-1">Правообладателям</p>
                                                        <p className="text-gray-500 dark:text-gray-700">abu@domatv.fun</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
