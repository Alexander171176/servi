  ...
  return (
    <DefaultLayout>
      ...
      <div className="mb-10 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="border-b border-stroke px-7 py-1 dark:border-strokedark">
        ...
        <div className="p-4 md:p-6 xl:p-9">
          <div className="mb-7.5 flex flex-wrap gap-5 xl:gap-20">
            <Link
              to="#"
              className="inline-flex items-center justify-center bg-primary py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-primary py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-full bg-primary py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md border border-primary py-1 px-10 text-center font-medium text-primary hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
          </div>
          ...
          <div className="mb-7.5 flex flex-wrap gap-5 xl:gap-20">
            <Link
              to="#"
              className="inline-flex items-center justify-center bg-meta-3 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-meta-3 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-full bg-meta-3 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md border border-meta-3 py-1 px-10 text-center font-medium text-meta-3 hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
          </div>
          ...
          <div className="flex flex-wrap gap-5 xl:gap-20">
            <Link
              to="#"
              className="inline-flex items-center justify-center bg-black py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-black py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-full bg-black py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md border border-black py-1 px-10 text-center font-medium text-black hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
          </div>
      ...
      <div className="mb-10 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="p-4 md:p-6 xl:p-9">
          ...
          <div className="mb-3.5 flex flex-wrap gap-5 xl:gap-20">
          <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-1 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-2 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-3 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-4 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
          </div>
          ...
          <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-5 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-6 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-7 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-8 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
          </div>
          ...
          <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-9 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-10 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-11 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-12 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
          </div>
          ...
          <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-13 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-14 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-15 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-16 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
          </div>   
          ...
          <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-17 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-18 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-19 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center rounded-md bg-color-20 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              Кнопка
            </Link>
          </div>                  
      ...
      <div className="mb-10 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="p-4 md:p-6 xl:p-9">
          <div className="mb-7.5 flex flex-wrap gap-5 xl:gap-7.5">
            <Link
              to="#"
              className="inline-flex items-center justify-center gap-2.5 bg-primary py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              <span>
                <svg
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center gap-2.5 bg-meta-3 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              <span>
                <svg
                  className="fill-current"
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center gap-2.5 bg-black py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              <span>
                <svg
                  className="fill-current"
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center gap-2.5 border border-primary py-1 px-10 text-center font-medium text-primary hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              <span>
                <svg
                  className="fill-current"
          ...
          <div className="mb-7.5 flex flex-wrap gap-5 xl:gap-7.5">
            <Link
              to="#"
              className="inline-flex items-center justify-center gap-2.5 rounded-md bg-primary py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              <span>
                <svg
                  className="fill-current"
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center gap-2.5 rounded-md bg-meta-3 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              <span>
                <svg
                  className="fill-current"
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center gap-2.5 rounded-md bg-black py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              <span>
                <svg
                  className="fill-current"
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center gap-2.5 rounded-md border border-primary py-1 px-10 text-center font-medium text-primary hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              <span>
                <svg
                  className="fill-current"
          ...
          <div className="flex flex-wrap gap-5 xl:gap-7.5">
            <Link
              to="#"
              className="inline-flex items-center justify-center gap-2.5 rounded-full bg-primary py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              <span>
                <svg
                  className="fill-current"
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center gap-2.5 rounded-full bg-meta-3 py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              <span>
                <svg
                  className="fill-current"
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center gap-2.5 rounded-full bg-black py-1 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              <span>
                <svg
                  className="fill-current"
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center gap-2.5 rounded-full border border-primary py-1 px-10 text-center font-medium text-primary hover:bg-opacity-90 lg:px-6 xl:px-8"
            >
              <span>
                <svg
                  className="fill-current"
